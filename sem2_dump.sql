CREATE TABLE AdministrativeStaff (
 ...
 availableTime TIME(6),
 availableInstructor VARCHAR(500)
);

ALTER TABLE AdministrativeStaff ADD CONSTRAINT PK_AdministrativeStaff PRIMARY KEY (id);
...
CREATE TABLE ScheduledTimeslots (
 id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
 time_slot TIME(6),
 time_and_date TIME(6)
);

ALTER TABLE ScheduledTimeslots ADD CONSTRAINT PK_ScheduledTimeslots PRIMARY KEY (id);
...
ALTER TABLE individual_lessons ADD CONSTRAINT FK_individual_lessons_1 FOREIGN KEY (administrative_staff_id) REFERENCES AdministrativeStaff (id);


ALTER TABLE lesson_time ADD CONSTRAINT FK_lesson_time_0 FOREIGN KEY (scheduled_timeslot_id) REFERENCES ScheduledTimeslots (id);
